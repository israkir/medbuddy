...
|----------|----------|-----------------|
| [`architecture.md`](architecture.md) | Engineers, security reviewers | System design, component map, data model, API reference, LLM integration, caching, privacy, deployment, configuration (15 sections) |
...
2. [`architecture.md`](architecture.md) — system design and component map
...
3. [`architecture.md`](architecture.md) §10 (Privacy and security) and §13 (Configuration)
...
4. [`architecture.md`](architecture.md) §12 (Deployment topology) and §13 (Configuration)
...
| What is the Supabase schema? | [`architecture.md`](architecture.md) §6 Data model |
...
| How do I add a new LLM adapter? | [`architecture.md`](architecture.md) §14 Extension points |
| How do I add a new intent / tool? | [`architecture.md`](architecture.md) §14, [`../apps/backend/README.md`](../apps/backend/README.md) |
