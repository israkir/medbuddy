...
- **update_profile** — Durable profile fields: how to address the user, age, gender, emergency contact, allergies, long-term health notes. One-off symptoms **not** meant as a dose log belong here or **general_question**, not confirm_dose, unless they explicitly tie it to a dose log (then use confirm_dose + **dose_adherence_note**).
