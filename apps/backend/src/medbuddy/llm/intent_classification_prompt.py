...
- **confirm_dose** — User reports they already took a dose (e.g. “I took it”, “吃了”, “took my morning pills”).
...
- **update_profile** — Only for durable profile fields: how to address the user, age, gender, emergency contact, allergies, long-term health notes on file. Not for one-off side effects or “notes for my doctor about this dose” unless they explicitly ask to save that on their profile.
